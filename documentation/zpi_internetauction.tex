...
\begin{document}
	...
	Jako użytkownik chciałbym mieć możliwość zobaczenia ile razy odwiedzono moją aukcję \emph{ (tj. licznik odsłon)}, żebym mógł zobaczyć statystyki odwiedzin mojej aukcji.
	...
	Jako użytkownik chciałbym mieć możliwość wyszukiwania interesujących mnie aukcji poprzez podanie słów kluczowych w wyszukiwarce, żebym mógł szybko znaleźć szukany przedmiot.
	
	\subsection{User story 13}
	Jako użytkownik chciałbym mieć możliwość prowadzenia wirtualnego portfela, który będę mógł zasilić, żebym mógł korzystać z jego zasobów oraz zapłacić za przedmioty.
	
	\subsection{User story 14}
	Jako użytkownik chciałbym mieć możliwość sprawdzenia starych aukcji które zostały zakończone (przedmiot sprzedano, przedmiot kupiono) bądź też wygasły, żebym mógl sprawdzić historie swojej transakcji.
