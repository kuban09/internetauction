...
\item Został stworzony formularz do backlogu "Baza danych", który ma na celu rejestrację nowych użytkowników. Dane są dodawane do tabeli użytkownicy (users), użytkownicy mają możliwość wprowadzenia podstawowych danych które spełniają wymagane kryteria i są konieczne do założenia konta na stronie serwisu.
...
\item Formularz sprawdza czy istnieje w bazie danych ten login oraz hasło i czy pasują do jednego użytkownika. Została zaimplementowana wiadomość zwrotna gdy użytkownik wpisze złe dane “nie ma takiego rekordu w bazie danych bądź hasło nie pasuje do loginu” jeśli dane są poprawne wyświetli się komunikat “logowanie powiodło się” i użytkownik zostanie przekierowany na główna stronę serwisu.
\end{itemize}
