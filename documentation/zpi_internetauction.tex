...
\begin{document}
	...
	\paragraph{Priorytet:} Wysoki
	\paragraph{Definition of Done:} Każda osoba wchodząca na stronę serwisu musi posiadać możliwość założenia konta. Wpisując podstawowe dane (tj. imię, nazwisko, miejscowość, numer telefonu, e-mail, numer konta bankowego) konto musi zostać stworzone w bazie danych. Należy zaimplementować funckję sprawdzająca istniejące loginy użytkowników oraz email aby jedna nazwa użytkownika i email należał do jednej osoby.
	...
	\paragraph{Priorytet:} Wysoki
	\paragraph{Definition of Done:} Każda osoba posiadająca swoje konto musi mieć możliwość wybrania formy aukcji (tj. licytacja, opcja ,,KUP TERAZ'' lub obydwie opcję).
